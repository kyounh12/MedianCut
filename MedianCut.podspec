...
Pod::Spec.new do |s|
  s.name             = 'MedianCut'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MedianCut.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/junseok_lee/MedianCut'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'junseok_lee' => 'kyounh12@snu.ac.kr' }
  s.source           = { :git => 'https://github.com/junseok_lee/MedianCut.git', :tag => s.version.to_s }
